      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
        <div className="flex flex-row justify-between items-center h-16 w-full">
          <div className="flex items-center flex-shrink-0">
            ...
            <div className="flex items-center space-x-3">
              <Image
                ...
                priority
              />
              <span className="text-base sm:text-xl font-bold text-indigo-800 whitespace-nowrap">
                TORAVEL PLANNER
              </span>
            </div>
          </div>
          ...
          <div className="hidden sm:flex items-center min-w-0 gap-x-2">
            <span className="text-gray-600 text-xs sm:text-base mr-2 sm:mr-4 truncate min-w-0 max-w-[100px] sm:max-w-xs">
              {user.email}
            </span>
            <button
